...
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
    GUI_ESC, HG(KC_A),HA(KC_S),HC(KC_D),HS(KC_F),KC_G,    KC_H,    HS(KC_J),HC(KC_K),HA(KC_L),HG(KC_SCLN), KC_QUOT,
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
    KC_UNDS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MINS_SFT,
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
    DEL_UI,  ___X___, ___X___, KC_LGUI, BSP_LOW, ENT_SFT, spc_nav, TAB_CTL, KC_RALT, ___X___, ___X___,  DEL_UI
// |-----------------------------------------------------------------------------------------------------------|
),
