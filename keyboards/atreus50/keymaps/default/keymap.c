 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------|
 * |   UI   |        |        |  Alt/\ |  GUI/` |Bsp/Low |Shft/del| Alt/ent| Space  | Ctrl/+ |    =   |        |        |  UI    |
 * `-----------------------------------------------------------------------------------------------------------------------------'
 */
[_BASE_LAYER] = LAYOUT(
    ...
    L_UI,    XXXXXXX, XXXXXXX, ALT_BSLS,GUI_GRV, BSP_LOW, SHFT_DEL,ALT_ENT, KC_SPACE,CTRL_PLS,KC_EQL,  XXXXXXX, XXXXXXX, L_UI
),
...
[_LOWER_LAYER] = LAYOUT(
    ...
    _______, _______, _______, KC_SLSH, KC_COLON,KC_LBRC,                   KC_RBRC, KC_1,    KC_2,    KC_3,    KC_0,    _______,
 ...
 */
[_UI_LAYER] = LAYOUT(
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, GUI_MIN, GUI_EQL, XXXXXXX,
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   GUI_LBR, GUI_RBR, XXXXXXX,
